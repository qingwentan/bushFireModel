...
def sparkModel(cfgJson, comparisonFile=None):
    ...
    for param in params:
        ...
        # can read/output a numpy array, try to implement the 2-way interaction between ABM and Spark
